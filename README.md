...
.NET 8 WPF 앱에서 Windows 기본 출력 장치의 마스터 음소거 상태를 읽고, 버튼으로 음소거와 음소거 해제를 전환하는 기능을 구현했습니다. 앱 시작과 현재 상태 읽기까지 확인했으며, 실제 음소거 전환은 사용자 환경에서 직접 확인해야 합니다.

**Windows 마스터 음소거: 구현 완료 / 실제 사용자 환경 검증 필요**

애플리케이션별 음소거와 전역 단축키는 아직 구현하지 않았습니다.

## 앞으로 구현할 기능

* Windows 마스터 음소거/음소거 해제 — 구현 완료, 실제 동작 수동 검증 필요
...
2. Windows 마스터 음소거/음소거 해제 구현 — 완료, 실제 동작 수동 검증 필요
